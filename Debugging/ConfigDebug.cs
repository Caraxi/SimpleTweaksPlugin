    ...
    public override void Draw() {
        if (ImGui.BeginTabBar("ConfigTabs")) {
            ...
            if (ImGui.BeginTabItem("UiConfig")) {
                DrawConfigBase(&Framework.Instance()->SystemConfig.SystemConfigBase.UiConfig);
                ImGui.EndTabItem();
            }
                ...
                if (ImGui.BeginTabBar("uiControlTabs")) {
                    if (ImGui.BeginTabItem("Current Setting")) {
                        ...
                        if (padMode == 0) {
                            ...
                            DrawConfigBase(&Framework.Instance()->SystemConfig.SystemConfigBase.UiControlConfig);
                        } else {
                            ImGui.Text("Controller");
                            DrawConfigBase(&Framework.Instance()->SystemConfig.SystemConfigBase.UiControlGamepadConfig);
                        }
...
{");
                        Generate(&Framework.Instance()->SystemConfig.SystemConfigBase.UiConfig, typeof(UiConfigOption));
                        ImGui.EndTabItem();
                    }
...
{");
                        Generate(&Framework.Instance()->SystemConfig.SystemConfigBase.UiControlConfig, typeof(UiControlOption));
                        ImGui.EndTabItem();
                    }
