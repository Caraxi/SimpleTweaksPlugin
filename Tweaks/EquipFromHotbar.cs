...
public unsafe class EquipFromHotbar : Tweak {
    ...
    [TweakHook(typeof(AgentInventoryContext), nameof(AgentInventoryContext.UseItem), nameof(UseItemDetour))]
    private readonly HookWrapper<AgentInventoryContext.Delegates.UseItem> useItemHook = null!;
